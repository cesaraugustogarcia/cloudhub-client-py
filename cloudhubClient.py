...
getLogs_parser.add_argument('-s','--start-date',dest='start_date',required=True,help="Enter date in this format: YYYY-mm-ddT00:00:00.000Z.")
getLogs_parser.add_argument('-e','--end-date',dest='end_date',required=True,help="Enter date in this format: YYYY-mm-ddT00:00:00.000Z.")
