...
credentials_parser.add_argument('-u','--cloudhub_user',required=True)
credentials_parser.add_argument('-p','--cloudhub_pass',required=True)

getApplicationInfo_parser = subparsers.add_parser('gai', help='Get Application Info method',parents=[credentials_parser])
getApplicationInfo_parser.add_argument('-a','--app_name',required=True)
...
getNotifications_parser.add_argument('-a','--app_name',required=True)
...
getSingleTenant_parser.add_argument('-a','--app_name',required=True)
...
getAllTenants_parser.add_argument('-a','--app_name',required=True)
...
loadTenant_parser.add_argument('-a','--app_name',required=True)
...
deleteTenant_parser.add_argument('-a','--app_name',required=True)
...
updateTenant_parser.add_argument('-a','--app_name',required=True)
...
updateTenantStatus_parser.add_argument('-a','--app_name',required=True)
...
getLogs_parser.add_argument('-a','--app_name',required=True)
